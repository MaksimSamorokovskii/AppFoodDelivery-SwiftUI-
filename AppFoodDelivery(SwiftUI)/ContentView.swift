//
//  ContentView.swift
//  AppFoodDelivery(SwiftUI)
//
//  Created by Максим Самороковский on 14.11.2023.
//
...
class FoodController: UICollectionViewController {
        ...
        return UICollectionViewCompositionalLayout { (sectionNumber, env) -> NSCollectionLayoutSection? in
            ...
            if sectionNumber == 0 {
                ...
                let group = NSCollectionLayoutGroup.horizontal(layoutSize:
                        ...
                        .estimated(500)), subitems: [item])
                let section = NSCollectionLayoutSection(group: group)
                section.contentInsets.leading = 16
                
                section.boundarySupplementaryItems = [
                    .init(layoutSize: .init(widthDimension: .fractionalWidth(1), heightDimension: .absolute(50)), elementKind: categoryHederId, alignment: .topLeading)
                ]
                
                return section
            } else if sectionNumber == 2 {
                let item = NSCollectionLayoutItem.init(layoutSize: .init(widthDimension: .fractionalWidth(1), heightDimension: .fractionalWidth(0.4)))
                item.contentInsets.top = 16
    ...
    static let categoryHederId = "categoryHederId"
    ...
    override func viewDidLoad() {
        ...
        collectionView.register(Header.self, forSupplementaryViewOfKind: FoodController.categoryHederId, withReuseIdentifier: headerId)
    }
